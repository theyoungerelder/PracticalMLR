...
the estimate is the beffierence between that factor and the baseline factor ( the baseline factor does not have an estimate). the estimate is the differnce between the factor and the baseline (ex. difference in bike rentals between spring and winter)
